...
echo "  4. Mission Control: Create 8 desktops, set CMD+1-8 shortcuts in System Settings > Keyboard > Shortcuts"
echo "  5. Alfred: Configure settings, set CMD+Space shortcut, activate Powerpack"
echo ""
